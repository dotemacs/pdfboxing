...
```clojure
 ...
 (pdf/split-pdfs {:input "pdfs/clojure.pdf" :start 1 :end 8}) ;=> (list of PDDocument pages 1 through 8)
 (pdf/split-pdfs {:input "pdfs/clojure.pdf"}) ;=> splits the pdf into single pages as a list of PDDocument
 ```
